    ...
    <Container id = "footer">
        <Profile>
            ...
            <div className="address">
                ...
                <Slide direction='left'><p>57 Larkana Nagar, Indore, India (452007)</p></Slide>
            </div>
            <div className="links">
                <Slide direction='left'><h1>Contact me directly</h1></Slide>
                <div>
                    <span><FiPhoneCall/></span>
                    <Slide direction='left'><a href='tel:+919752909668'>+91 975 290 9668 </a></Slide>
                </div>
                <div>
                    <Slide direction='left'><span><HiOutlineMailOpen/></span></Slide>
                    <Slide><a href='mailto:nimeshthakur0@gmail.com'>nimeshthakur0@gmail.com</a></Slide>
                </div>
            </div>
